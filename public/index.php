...
$router->post('/genreUpdate', [GenreController::class, 'updateProcess']); // Con parámetro
...
$router->post('/consoleUpdate', [ConsoleController::class, 'updateProcess']); // Con parámetro
...
$router->post('/consoleModelUpdate', [ModelController::class, 'updateProcess']);  // Con parámetro
...
$router->post('/videogamesUpdate', [VideogameController::class, 'updateProcess']); // Con parámetro
